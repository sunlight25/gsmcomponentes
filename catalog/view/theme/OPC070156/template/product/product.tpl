...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php } ?>
        ...
        <?php $class = 'col-sm-4'; ?>
        <?php } ?>
        <div class="<?php echo $class; ?> right">
          ...
          <ul class="list-unstyled">
            <?php if (!$special) { ?>
            <li>
              <h2 class="regular-price"><?php echo $price; ?></h2>
            </li>
            <?php } else { ?>
            <li><span class="regular-price" style="text-decoration: line-through;"><?php echo $price; ?></span></li>
            <li>
          ...
          <div id="product">
            ...
            <h3 class="inner-title"><?php echo $text_option; ?></h3>
			...
			<div class="btn-group">
				<button type="button" class="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><span><?php echo $button_wishlist; ?></span></button><br/>
				<button type="button" class="compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><span><?php echo $button_compare; ?></span></button>
			</div>
				...
				<div class="<?php if ($productCount >= $sliderFor){?>slider-item<?php }else{?>product-items<?php }?>">
				  ...
				  <?php } ?>
					...
					<button type="button" class="addtocart" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span></button>
					  ...
					  <button type="button" class="wishlist_button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
					  <button type="button" class="compare_button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
					</div>
