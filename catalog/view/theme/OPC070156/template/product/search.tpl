  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<?php } ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 search-sort">
        ...
        <div class="col-sm-3 search-subcategory">
            ...
            <div class="productdetail-inner">
              <div class="caption">
                <h4 class="product-name">
					...
					<?php if (strlen(($product['name'])) > 150)
					{ 
						$maxLength = 150 ; echo substr($product['name'],0,$maxLength).""; 
					}
					else{
						echo ($product['name']);
					}
				...
				<?php } ?>	
				 <button class="wishlist_button" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></button>
                <button class="compare_button" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i><span><?php echo $button_compare; ?></span></button>
              </div>
