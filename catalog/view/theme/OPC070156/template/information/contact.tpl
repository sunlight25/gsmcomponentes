...
<ul class="breadcrumb">
			...
			<div class="right">
				<div class="map">
				<script type="text/javascript" src="http://www.webestools.com/google_map_gen.js?lati=39.9821205&long=-0.0402619&zoom=16&width=350&height=200&mapType=normal&map_btn_normal=yes&map_btn_satelite=yes&map_btn_mixte=yes&map_small=yes&marqueur=yes&info_bulle="></script>
				</div>
			</div>
            <div class="col-sm-3">
              <?php if ($open) { ?>
