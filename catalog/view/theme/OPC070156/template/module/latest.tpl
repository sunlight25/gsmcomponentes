<div class="box">
  ...
  <div class="box-content">
	...
	<div class="box-product <?php if ($productCount >= $sliderFor){?>product-carousel<?php }else{?>product-grid<?php }?>" id="<?php if ($productCount >= $sliderFor){?>latest-carousel<?php }else{?>latest-grid<?php }?>">
		...
		<?php } ?>	
      	<div class="productdetail-wrapper">
			...
			<div class="button-group">
				<div class="button-container"><button class="addtocart" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></button></div>
